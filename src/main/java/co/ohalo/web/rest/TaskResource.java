...
import co.ohalo.domain.Task;
import co.ohalo.repository.TaskRepository;
import co.ohalo.service.TaskService;
...
/**
 * REST controller for managing {@link co.ohalo.domain.Task}.
 */
@RestController
@RequestMapping("/api")
