...
import co.ohalo.domain.Location;
import co.ohalo.repository.LocationRepository;
import co.ohalo.service.LocationService;
...
/**
 * REST controller for managing {@link co.ohalo.domain.Location}.
 */
@RestController
@RequestMapping("/api")
