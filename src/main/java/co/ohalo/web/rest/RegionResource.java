...
import co.ohalo.domain.Region;
import co.ohalo.repository.RegionRepository;
import co.ohalo.service.RegionService;
...
/**
 * REST controller for managing {@link co.ohalo.domain.Region}.
 */
@RestController
@RequestMapping("/api")
