...
import co.ohalo.domain.Country;
import co.ohalo.repository.CountryRepository;
import co.ohalo.service.CountryService;
...
/**
 * REST controller for managing {@link co.ohalo.domain.Country}.
 */
@RestController
@RequestMapping("/api")
