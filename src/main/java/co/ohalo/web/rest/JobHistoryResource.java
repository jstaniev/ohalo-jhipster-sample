...
import co.ohalo.domain.JobHistory;
import co.ohalo.repository.JobHistoryRepository;
import co.ohalo.service.JobHistoryService;
...
/**
 * REST controller for managing {@link co.ohalo.domain.JobHistory}.
 */
@RestController
@RequestMapping("/api")
